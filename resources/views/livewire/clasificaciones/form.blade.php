<div class="col-lg-6">
    <div class="card">
        <div class="card-header"> @if( $selected_id == 0) Registrar clasificacion @else Editar clasificacion @endif</div>
        ...
        <div class="card-body">
            ...
            <form  novalidate="novalidate">
                <div class="form-group has-success">
                    ...
                    <input wire:model.lazy="nombre"   type="text" class="form-control cc-name valid">
                </div>         
				    <div class="row">
